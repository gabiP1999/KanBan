...
namespace NUnitTestProject1
{
    class moqTest
    {
        ...
        public void Setup()
        {
            column = new Mock<IColumn>(); 
        }

        [Test]
        public void AddTask_TaskLimit_Success()
        {
            Column column = new Column(0, "backlog", 6);
            Task t = new Task(2, 2, DateTime.Parse("06-06-2019"), DateTime.Parse("06-06-2022"), "home work", "do home work in math", "a");
            column.AddTask(t);
